 ...
 * Uses the internal /api/v1/chat endpoint.
 */
export async function POST(request: NextRequest) {
  try {
    ...
    // Use the internal API - either env var or same origin
    ...
    const targetUrl = apiUrl ? `${apiUrl}/api/v1/chat` : `${request.nextUrl.origin}/api/v1/chat`;
