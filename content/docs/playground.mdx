...
<Callout type="info">
**Try it now:** [Open Standalone Playground](https://playground-ten-woad.vercel.app) - Full-featured playground with all 21 models
</Callout>
...
| Model selection (21 models) | ✅ Working |
| Code export (TypeScript/cURL/Python) | ✅ Working |
...
|---------|----------|-----|
| **Vision (image input)** | High | Next release |
| **Image generation** | High | Next release |
| **Tool/function calling** | Medium | Q1 2026 |
| **JSON structured output** | Medium | Q1 2026 |
| **PDF processing** | Low | Q1 2026 |
| **Extended thinking display** | Low | Q1 2026 |
...
- Not yet available in standalone playground (coming soon)
- Will support: gemini-2.5-flash-image, gemini-3-pro-image
...
**Standalone Playground:** [https://playground-ten-woad.vercel.app](https://playground-ten-woad.vercel.app)

The playground is also embedded on model documentation pages:
